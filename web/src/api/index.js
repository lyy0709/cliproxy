...
export default {
  ...
  // Admin - Models
  getModels: (params) => Get('/admin/models-config', { params }),
  getModel: (id) => Get(`/admin/models-config/${id}`),
  createModel: (data) => Post('/admin/models-config', data),
  updateModel: (id, data) => Put(`/admin/models-config/${id}`, data),
  ...
  adminGetAPIKey: (id) => Get(`/admin/api-keys/${id}`),
  adminCreateAPIKey: (data) => Post('/admin/api-keys', data),
  adminUpdateAPIKey: (id, data) => Put(`/admin/api-keys/${id}`, data),
  adminDeleteAPIKey: (id) => Delete(`/admin/api-keys/${id}`),
  adminToggleAPIKey: (id) => Put(`/admin/api-keys/${id}/toggle`),
  ...
  adminGetUsageSummary: (params) => Get('/admin/usage/summary', { params }),
  adminGetDailyUsage: (params) => Get('/admin/usage/daily', { params }),
  adminGetModelUsage: (params) => Get('/admin/usage/models', { params }),
  adminGetAPIKeyUsageSummary: (params) => Get('/admin/usage/api-keys', { params }),
  adminGetUsageRecords: (params) => Get('/admin/usage/records', { params }),
